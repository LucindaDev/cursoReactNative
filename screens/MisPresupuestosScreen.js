      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.presupuestoItem}>
            <TouchableOpacity
              style={{ flex: 1 }}
              onPress={() => navigation.navigate('DetallesPresupuesto', { presupuesto: item })}
            >
            ...
            <View style={styles.iconosContainer}>
              <TouchableOpacity onPress={() => editarPresupuesto(item.id)}>
                <Icon name="pencil" size={20} color="#007bff" style={styles.icono} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => eliminarPresupuesto(item.id)}>
                <Icon name="trash" size={20} color="#d9534f" style={styles.icono} />
              </TouchableOpacity>
            </View>
          </View>
        )}
      ...
      <Modal visible={modalVisible} animationType="slide">
        <View style={styles.modalContainer}>
          <TextInput
            ...
            onChangeText={(text) => setNuevoPresupuesto({ ...nuevoPresupuesto, nombre: text })}
          />
          <TextInput
            ...
            onChangeText={(text) => setNuevoPresupuesto({ ...nuevoPresupuesto, ingreso: text })}
          />
          <TextInput
            ...
            onChangeText={(text) => setNuevoPresupuesto({ ...nuevoPresupuesto, categorias: text })}
          />
          <View style={styles.botonContainer}>
            <TouchableOpacity style={styles.botonGuardar} onPress={agregarPresupuesto}>
